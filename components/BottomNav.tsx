...
export default function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 z-20 border-t border-black/[0.06] bg-white/90 px-3 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur-md lg:hidden">
