...
<main><section class="hero"><small>ROLEPLAY / 2026-09-24</small><h1>ラポール重視版</h1><p>浅く聞く → 趣味で会話 → 許可 → フックへ戻って縦掘り</p></section>
...
<div class="row secondary"><button id="review">未暗記だけ復習</button><button id="tools">編集・設定</button></div><p id="status" role="status">2026年9月24日版を表示</p>
...
<script type="application/json" id="seed">${JSON.stringify(sugiyamaMarkdown).replace(/</g, '\\u003c')}</script><script src="/sugiyama-reading.js?v=2" defer></script><script src="/sugiyama.js?v=4" defer></script></body></html>`;
