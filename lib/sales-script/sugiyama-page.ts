...
<script type="application/json" id="seed">${JSON.stringify(sugiyamaMarkdown).replace(/</g, '\\u003c')}</script><script src="/sugiyama-reading.js?v=2" defer></script><script src="/sugiyama.js?v=5" defer></script></body></html>`;
