...
export async function GET(request: Request) {
  ...
  if (/\/sales-script\/?$/.test(path)) {
    ...
    const legacy = page.replace('<div class="app">', '<div class="app"><nav style="padding:16px;background:white"><a href="/sales-script">← 杉山さん版 V5</a> ／ 茂木さん版</nav>').replace('</body>', '<script src="/script-speech.js" defer></script></body>');
