...
export default function OverviewPage() {
  ...
  return <div className="mx-auto max-w-5xl px-5 py-8 sm:px-8 lg:py-12">
    <header className="mb-8 flex flex-wrap items-start justify-between gap-4"><div><p className="text-[14px] font-medium tracking-widest text-slate-500">WORKSPACE</p><h1 className="mt-2 text-3xl font-bold tracking-tight">目標から、次の一歩へ。</h1><p className="mt-3 text-sm leading-7 text-slate-600">仕事も学びも人生目標も。いま必要な判断を、ここで確認。</p></div><Link href="/today" className="rounded-xl bg-accent px-5 py-3 text-sm font-medium text-white hover:bg-accent-dark">今日の作業へ →</Link></header>
