...
export default function TodayPage() {
  ...
  function confirmComplete(task: Task, metDefinitionOfDone: boolean) {
    ...
    const record = sessionCompletion(task, { date: today, nowIso: new Date().toISOString(), sessions: workSessions, actual: taskActualMinutes, metDefinitionOfDone, deadlineOverrides });
